...
void ShaderProgram::SetUniform(const std::string &location, LiteMath::float4 value) const
{
  GLint uniformLocation = glGetUniformLocation(shaderProgram, location.c_str());
  if (uniformLocation == -1)
  {
...
void ShaderProgram::SetUniform(const std::string &location, LiteMath::float3 value) const
{
  GLint uniformLocation = glGetUniformLocation(shaderProgram, location.c_str());
  if (uniformLocation == -1)
  {
...
void ShaderProgram::SetUniform(const std::string &location, LiteMath::float2 value) const
{
  GLint uniformLocation = glGetUniformLocation(shaderProgram, location.c_str());
  if (uniformLocation == -1)
  {
